...
public class CrossOriginFilter implements Filter
{
    ...
    public void init(FilterConfig config) throws ServletException
    {
        ...
        if (allowedMethodsConfig == null)
            ...
            allowedMethods.addAll(Arrays.asList(csvSplit(allowedMethodsConfig)));
        ...
        if (allowedHeadersConfig == null)
            ...
            allowedHeaders.addAll(Arrays.asList(csvSplit(allowedHeadersConfig)));
        ...
        exposedHeaders.addAll(Arrays.asList(csvSplit(exposedHeadersConfig)));
    ...
    private boolean generateAllowedOrigins(List<String> allowedOriginStore, String allowedOriginsConfig, String defaultOrigin) 
    {
        ...
        String[] allowedOrigins = csvSplit(allowedOriginsConfig);
    ...
    private List<String> getAccessControlRequestHeaders(HttpServletRequest request)
    {
        ...
        String[] headers = csvSplit(accessControlRequestHeaders);
    ...
    */
    private String[] csvSplit(String s)
    {
        if (s==null)
            return null;
     ...
     * @return An array of parsed values.
     */
    private String[] csvSplit(String s, int off,int len)
    {
        if (s==null)
            return null;
     ...
     */
    private List<String> csvSplit(List<String> list,String s, int off,int len)
    {
        if (list==null)
            list=new ArrayList<>();
