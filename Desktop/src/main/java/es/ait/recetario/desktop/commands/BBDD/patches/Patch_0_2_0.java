...
public class Patch_0_2_0 implements BBDDPatch
{
    ...
    public void run(Connection connection) throws SQLException
    {
        ...
        {
            ps.setString(1, Preferences.getInstance().getRecetarioName() );
            ps.executeUpdate();
        }
        ...
        try ( PreparedStatement ps = connection.prepareStatement("alter table recipe alter column "
            + "recipe_origin not null"))
        {
            ps.executeUpdate();
        }
        ...
        try ( PreparedStatement ps = connection.prepareStatement(" update version set app_version = '0.2.0'"))
        {
            ps.executeUpdate();
        }
    }
